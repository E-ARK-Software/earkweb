...
def import_package(current_task, src_zip, identifier_map = default_map):
    ...
    #return
    chain_1_classes = [ SIPtoAIPReset, SIPDeliveryValidation, IdentifierAssignment, SIPExtraction, SIPValidation, SIPRestructuring, AIPDescriptiveMetadataValidation, AIPMigrations]
