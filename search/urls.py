...
urlpatterns= patterns('',
    ...
    url(r'^selectedaipstable$', views.selectedaipstable, name='selectedaipstable'),
    ...
    url(r'^aipselection/([^/]+)$', views.aipselection, name='aipselection'),
    url(r'^aipselectiondropdown$', views.aipselectiondropdown, name='aipselectiondropdown'),
