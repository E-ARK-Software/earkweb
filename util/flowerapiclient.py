...
from config.configuration import flower_path, flower_port, flower_server, verify_certificate


def get_task_info(task_id):
    flower_request_url = 'http://%s:%s%sapi/tasks' % (flower_server, flower_port, flower_path)
