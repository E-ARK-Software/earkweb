...
urlpatterns = [
    ...
    url(r'^upload_step3/(?P<pk>\d+)/?', submission.views.upload_step3, name='upload_step3'),
    url(r'^upload_step4/(?P<pk>\d+)/?', submission.views.upload_step4, name='upload_step4'),
    url(r'^upload_step5/(?P<pk>\d+)/?', submission.views.upload_step5, name='upload_step5'),
    url(r'^updatedistrmd', submission.views.updatedistrmd, name='updatedistrmd'),
    url(r'^upload_step5/(?P<pk>\d+)/(?P<rep>[A-Za-z0-9-_]{4,200})/$', submission.views.upload_step5_rep, name='upload_step5_rep'),
